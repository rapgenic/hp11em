...
DebugWindow::DebugWindow(Signals *hpsignals_r)
    : boxReg("Registers Dump"), lab_reg("Register"), lab_val("Value"),
      lab_x("X"), lab_y("Y"), lab_z("Z"), lab_t("T"), lab_lst_x("LSTx"),
      lab_x_val("0"), lab_y_val("0"), lab_z_val("0"), lab_t_val("0"),
      lab_lst_x_val("0"), quitBtn("Chiudi") {
  ...
  hpsignals->signal_update_registers_table().connect(
      sigc::mem_fun(*this, &DebugWindow::update_table_registers));
