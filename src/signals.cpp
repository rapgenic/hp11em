...
void Signals::sig_display_emit(std::string disp) {
...
Signals::signal_t Signals::signal_reset() {
        return sig_reset;
}

void Signals::sig_reset_emit() {
        sig_reset.emit();
}
...
void Signals::sig_back_window_toggle_emit() {
        sig_back_window_toggle.emit();
}
