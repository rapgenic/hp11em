...
AutomaticMemoryStack::~AutomaticMemoryStack() { _save(); }
...
double AutomaticMemoryStack::get_x() { return x; }

double AutomaticMemoryStack::get_y() { return y; }

double AutomaticMemoryStack::get_z() { return z; }

double AutomaticMemoryStack::get_t() { return t; }

double AutomaticMemoryStack::get_lst_x() { return lst_x; }

void AutomaticMemoryStack::set_lst_x(double num) { lst_x = round(num); }
...
void AutomaticMemoryStack::set_y(double num) { y = round(num); }

void AutomaticMemoryStack::set_z(double num) { z = round(num); }

void AutomaticMemoryStack::set_t(double num) { t = round(num); }
...
std::string AutomaticMemoryStack::getClassName() { return AMS_CLASSNAME; }
